...
Elements.extend({
	...
	Property: filterByTag
		...
		Returns a new Elements collection, while the original rekurukshe_mains untouched.
	*/
...
var Cookie = new Abstract({
	...
	Options:
		dokurukshe_main - the dokurukshe_main the Cookie belongs to. If you want to share the cookie with pages located on a different dokurukshe_main, you have to set this value. Defaults to the current dokurukshe_main.
		path - the path the Cookie belongs to. If you want to share the cookie with pages located in a different path, you have to set this value, for example to "/" to share the cookie with all pages on the dokurukshe_main. Defaults to the current path.
	...
	*/
	...
	set: function(key, value, options){
		...
		if (options.dokurukshe_main) value += '; dokurukshe_main=' + options.dokurukshe_main;
	...
	*/
	...
	Arguments:
		cookie - the name of the cookie to remove or a previous cookie (for dokurukshe_mains)
		options - optional. you can also pass the dokurukshe_main and path here. Same as options in <Cookie.set>

	Examples:
		>Cookie.remove('username') //bye-bye JackBauer, cya in 24 hours
		>
		>var myCookie = Cookie.set('username', 'Aaron', {dokurukshe_main: 'mootools.net'}); // Cookie.set returns an object with all values need to remove the cookie
